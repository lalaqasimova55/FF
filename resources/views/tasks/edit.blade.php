...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-bold text-gray-800">Task Düzəliş Et</h1>
    ...
    <form method="POST" action="{{ route('tasks.update', $task) }}">
        ...
        <div class="mb-4">
            ...
            <select name="status" class="w-full border rounded px-3 py-2">
                <option value="pending"   {{ old('status', $task->status) == 'pending'   ? 'selected' : '' }}>Gözləyir</option>
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('tasks.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded hover:bg-gray-300">
                Ləğv et
            </a>
        </div>
    </form>
